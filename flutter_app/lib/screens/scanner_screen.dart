    ...
    return Scaffold(
                ...
                AnimatedTextKit(
                  animatedTexts: [
                    TypewriterAnimatedText(
                      "Get a hacker's perspective on your web apps",
                                  ...
                                  return Padding(
                                    ...
                                    child: ShaderMask(
                                      ...
                                      child: CircularProgressIndicator(
                                        value: value,
                                        strokeWidth: 15, // Thicker progress bar
                                        valueColor:
                      ...
                      GestureDetector(
                        ...
                        child: MouseRegion(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  Colors.grey.shade300, // Light gray tile color
                              borderRadius: BorderRadius.circular(
                                  15), // Reduced border radius
                              border: Border.all(
                                color:
                                    Colors.grey.shade400, // Subtle gray border
                                width: 3,
                              ),
                              boxShadow: [
                                BoxShadow(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Padding(
          ...
          child: Text(
            '© 2025 Vulnerability Scanner. All rights reserved.',
            textAlign: TextAlign.center,
            style: GoogleFonts.poppins(
              fontSize: 16,
              color: Colors.white,
